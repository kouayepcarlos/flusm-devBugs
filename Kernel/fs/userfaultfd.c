...
{	
	...
	case 4: {
			int ret = uffd_eMod(ctx->mm, uffdio_palloc.addr, uffdio_palloc.uaddr);
			if (likely(ret == 1)) {
...
SYSCALL_DEFINE1(userfaultfd, int, flags)
{
	...
	if ((flags & UFFD_USM) !=0) {
		...
		current->mm->def_flags |= VM_UFFD_MISSING | VM_UFFD_MINOR/* | VM_PFNMAP*/; /* | VM_IO;  | VM_LOCKED | VM_IO;		 UFFD_USM ! */
